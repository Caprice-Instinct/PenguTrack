...
function ReceiptList() {
  ...
  if (!user) {
    return (
      <div className="w-full p-8 text-center">
        <p>Please sign in to view your receipts</p>
      </div>
    );
  }
  ...
  if (!receipts) {
    return (
      <div className="w-full p-8 text-center">
        <div className="animate-spin rounded-full h-10 w-10 border-t-2 vorder-b-2 border-blue-500 mx-auto"></div>
  ...
  if (receipts.length === 0) {
    return (
      <div className="w-full text-center p-8 border border-gray-200 rounded-lg bg-gray-50">
